...
"""
to run : py -m metrics.Metric6.ml.RF_grid
"""
...
def optimize_random_forest(df):
    ...
    test_size_=0.4 #put 0.2

    feature_cols =  ['price', 'sma_100d', 'pe', 'peg', 'EVGP', '1Y_6M_growth']

    feature_cols1 =['price', 'sma_100d', 'RnD_expenses', 'EV', 'maxPercen_4M', 'max_in_2W',
    ...
    feature_cols =['price', 'pe_ratio', 'sma_100d', 'RnD_expenses', 'marketCap', 'EV',
...
"""
{'max_depth': 10, 'max_features': None, 'min_samples_leaf': 1, 'min_samples_split': 2, 'n_estimators': 200}
