...
"""
to run : py -m metrics.Metric8.ml.data_cleaning
"""

training_data_path = 'metrics/Metric8/ml/training_data_raw.csv'
# Read the CSV file
...
df.to_csv('metrics/Metric8/ml/cleaned_training_data.csv', index=False)
