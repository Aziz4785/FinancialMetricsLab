...
def load_models():
    with open('metrics/Metric8/models/RF_11_18.pkl', 'rb') as model_file:
        model = pickle.load(model_file)
    with open('metrics/Metric8/models/scaler_11_18.pkl', 'rb') as scaler_file:
        scaler = pickle.load(scaler_file)
    with open('metrics/Metric8/models/XGB5_10_24.pkl', 'rb') as model_file:
        model2 = pickle.load(model_file)
    with open('metrics/Metric8/models/scaler_10_24.pkl', 'rb') as scaler_file:
        scaler2 = pickle.load(scaler_file)
    with open('metrics/Metric8/models/XGB5_4_20.pkl', 'rb') as model_file:
        model3 = pickle.load(model_file)
    with open('metrics/Metric8/models/scaler_4_20.pkl', 'rb') as scaler_file:
        scaler3 = pickle.load(scaler_file)
    with open('metrics/Metric8/models/RF1_3_26.pkl', 'rb') as model_file:
        model4 = pickle.load(model_file)
    with open('metrics/Metric8/models/scaler_3_26.pkl', 'rb') as scaler_file:
