...
"""
to run : py -m metrics.Metric9.ml.xgboost_grid
"""
...
def optimize_xgboost(df):
    ...
    feature_cols =['price', 'gp_ratio', 'month', 'RnD_expenses', 'GP', 'netIncome',
...
"""
{'colsample_bytree': 0.9, 'gamma': 0, 'learning_rate': 0.3, 'max_depth': 8, 'min_child_weight': 1, 'n_estimators': 200, 'subsample': 0.6}
"""