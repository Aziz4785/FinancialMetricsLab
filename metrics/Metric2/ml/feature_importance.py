...
"""
to run : py -m metrics.Metric2.ml.feature_importance
"""
...
columns_to_use =['price','ratio','sma_10d','sma_50w','sma_100d','sma_200d','sma_50d','other_expenses','NetProfitMargin','ebitdaMargin','interestCoverage','eps','costOfRevenue','netIncome','revenues','pe_ratio','cost_revenue_ratio','revenues_lag_days']
