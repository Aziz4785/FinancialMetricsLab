...
def load_models():
    with open('C:/Users/aziz8/Documents/FinancialMetricsLab/metrics/Metric2bis/models/RF4a_5_6.pkl', 'rb') as model_file:
        model = pickle.load(model_file)
    with open('C:/Users/aziz8/Documents/FinancialMetricsLab/metrics/Metric2bis/models/scaler_5_6.pkl', 'rb') as scaler_file:
        scaler = pickle.load(scaler_file)
    with open('C:/Users/aziz8/Documents/FinancialMetricsLab/metrics/Metric2bis/models/RF4a_4_18.pkl', 'rb') as model_file:
        model2 = pickle.load(model_file)
    with open('C:/Users/aziz8/Documents/FinancialMetricsLab/metrics/Metric2bis/models/scaler_4_18.pkl', 'rb') as scaler_file:
        scaler2 = pickle.load(scaler_file)
    with open('C:/Users/aziz8/Documents/FinancialMetricsLab/metrics/Metric2bis/models/XGB4_4_18.pkl', 'rb') as model_file:
...
def predict_buy(model,scaler,features_for_pred,input_date,symbol,ps_ratio,price_at_date,
    ...
    evebitda =safe_divide(EV,safe_dict_get(income_features,'ebitda'))
