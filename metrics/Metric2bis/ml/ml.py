...
"""
to run : py -m metrics.Metric2bis.ml.ml
...
feature_subsets = [
    ...
    ,['price', 'sma_100d', 'sma_50w','sma_200d', 'sma_50d', 'GP',
      ...
      ['revenues', 'price', 'pe', 'ps_ratio', 'sma_100d', 'sma_200d'],

      ['markRevRatio', 'sma_50w', 'sma_200d', 'sma_100d', 'price', 'sma_10d'],
]
...
for i, subset in enumerate(feature_subsets):
    ...
    for name, model in models.items():
        ...
        if precision>0.965 and specificity>0.965:
