...
"""
to run : py -m metrics.Metric2bis.ml.RF_grid
"""
...
def optimize_random_forest(df):
    ...
    test_size_=0.75 #put 0.2
    feature_cols = ['price', 'sma_200d', 'GP', 'marketCap', 'EV', 'max_in_4M', 'max_in_2W',
        'pe', 'peg', 'EVEbitdaRatio', 'EVGP', 'EVRevenues']

    feature_cols = ['price', 'sma_200d', 'peg', 'EVEbitdaRatio']

    feature_cols1 =  ['price', 'sma_100d', 'sma_50w','sma_200d', 'sma_50d', 'GP',
